...
transform = transforms.Compose([
    ...
    transforms.transforms.Resize((256, 256), interpolation=transforms.InterpolationMode.BILINEAR),
...
for epoch in range(n_epochs):
    ...
    torch.save(model.state_dict(), 'checkpoints_SDA/checkpoint epoch {}.pt'.format(n_epochs))
