...
for epoch in range(n_epochs):
    ...
    with open('stats_interpolation_3.csv', 'w', newline='') as file:
    ...
    if evaluate_balanced_accuracy > highest_evaluation_accuracy:
        ...
        torch.save(model.state_dict(), 'checkpoints_interpolation_3/checkpoint highest accuracy.pt')

    elif (epoch + 1) % 50 == 0:
        torch.save(model.state_dict(), 'checkpoints_interpolation_3/checkpoint epoch {}.pt'.format(epoch + 1))
